        ...
        <div class="mmenu-inner pt-10">
            ...
            @auth
                <div class="flex items-center">
                    <img src="{{auth()->user()->avatar}}" class="w-14 h-14 rounded-full" alt="Михаил Бурлет">
            ...
            @elseguest
                <a href="{{route('login.page')}}" class="profile flex items-center mr-12">
                    <svg class="profile-icon w-8 h-8 " fill="#fff" xmlns="http://www.w3.org/2000/svg"
            ...
            <nav class="flex flex-col mt-8">
                <a href="{{route('home')}}"
                   class="self-start py-1 text-dark hover:text-pink text-md font-bold">Главная</a>
